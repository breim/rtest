...
RSpec.describe PostsController, type: :controller do
  ...
  let(:valid_attributes) {
    { title: 'Aqui vai o titulo do test', content: 'Aqui vai o conteudo boladão' }
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        {title: 'NewFirstName', content: 'NewLastName'}
      }
      ...
      it "updates the requested post" do
        ...
        post.reload
        expect(post.title).to eq('NewFirstName')
        expect(post.content).to eq('NewLastName')
      end
